...
function validateNumber (number) {
    ...
    if(isNaN(number) || (number == '')){
        ...
        const visit={
                 ...
                 cost:" 20000/person",
                 persons:number,
                 discount : (number * 20000)*0.1 + ' (10%)',
                 costForTotalPersons : (number * 20000) - (number * 20000)*0.1,
                //  totalCost: (costForTotalPersons - (costForTotalPersons*(10*0.01))),
         }
        cart.push(visit);
        console.log(cart);
        localStorage.setItem("countryP","Paris");
        localStorage.setItem("costP",visit.cost);
        localStorage.setItem("personsP",visit.persons);
        localStorage.setItem("discountP",visit.discount);
        localStorage.setItem("costForTotalPersonsP",visit.costForTotalPersons);
    }
...
var CustomPrompt1 = new function(){
    ...
    this.cartData1 = document .getElementById('cartData1');
